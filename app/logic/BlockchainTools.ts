...
export default async function lookupCertificate(id: String, lastName: String): Promise<any> {
        const cmd = {
            ...
            keyPairs: KP,
            pactCode: Pact.lang.mkExp('coding-certification.coding-certification.read-certificate', id)
            // envData: {},
            // meta: {
...
export function createCert(id: string, name: string) {
    const cmd = {
        keyPairs: KP,
        // Dummy data
        pactCode: Pact.lang.mkExp('coding-certification.coding-certification.create-credential', id, name, "2016-07-23T13:30:45Z", 100500.1, "as:12,s:1,r:23", "1,2,3A", "0")
    }
